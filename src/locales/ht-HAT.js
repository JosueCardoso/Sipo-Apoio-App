export default {
  ...
  location: 'Kote',
  welcomeToBrazil: 'Byenveni nan peyi Brezil',
  helloFriend: 'Alo zanmi!',
  thisAppFinally: 'Aplikasyon sa a gen pou objektif pote enfòmasyon esansyèl pou mobilite ou isit la nan Brezil',
  thisAppObjective: 'Objektif aplikasyon sa a se fasilite kominikasyon nan divès sitiyasyon ki ka gen eksperyans nan nouvo peyi ou',
  next: 'Next',
  previous: 'Previous',
  conclude: 'Konklizyon',
  ...
  informationText1: 'Aplikasyon an soti nan pwogram mèt la nan pratik transkiltirèl nan Centro Universitário UniFacvest la, atravè pwojè a nan elèv la mèt Bruno Muniz Silva, sipèvize pa Dra Arceloni Neusa Volpato ak ko-sipèvize pa Dra Soeli Satub zembruski.',
  informationText2: 'Pati nan teknik nan aplikasyon an te responsablite nan pwogramè Josué Cardoso la.',
