...
import { Container, ContainerTest, TitleContainer, Arrow, ButtonCard } from './styles';
...
const card = ({ value }) => {
    ...
    const wordList = isExpanded ? <WordList words={value.words} isExpanded={isExpanded} /> : <WordList words={[]} isExpanded={isExpanded} />;
